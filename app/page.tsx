        ...
        <div className="space-y-6 relative z-10">
          <table className="w-full border-collapse border-2 border-black text-sm text-left">
            <tbody>
              {/* 1행: 품명 / 시험항목 종류 */}
              <tr>
                <th className="border border-black bg-gray-50 p-3 w-1/6 font-semibold text-center whitespace-normal">품명</th>
                ...
                <th className="border border-black bg-gray-50 p-3 w-1/6 font-semibold text-center whitespace-normal">시험항목<br />종류</th>
                <td className="border border-black p-2 w-2/6 bg-white/80">
              ...
              {/* 2행: 제조번호 / 제조자 및 납품자 */}
              <tr>
                <th className="border border-black bg-gray-50 p-3 font-semibold text-center whitespace-normal">제조번호<br />(Lot No.)</th>
                ...
                <th className="border border-black bg-gray-50 p-3 font-semibold text-center whitespace-normal">제조자 /<br />납품자</th>
                <td className="border border-black p-2 bg-white/80">
                  {!isCustomManufacturer ? (
                    ...
                    <div className="flex gap-2">
                      <input className="border p-2 w-full rounded" placeholder="직접 입력" value={manufacturerSupplier} onChange={(e) => setManufacturerSupplier(e.target.value)} />
              ...
              <tr>
                ...
                <td className="border border-black p-2 bg-white/80">
                  <input type="date" className="border p-2 w-full rounded" value={requestDate} onChange={(e) => setRequestDate(e.target.value)} />
                </td>
              </tr>

              {/* 5행: 채취량 / 의뢰부서 */}
              <tr>
                <th className="border border-black bg-gray-50 p-3 font-semibold text-center whitespace-normal">채취량</th>
                <td className="border border-black p-2 bg-white/80">
                  {!isCustomSampleQty ? (
                    <select
                      className="border p-2 w-full rounded bg-white"
                    ...
                    <div className="flex gap-2">
                      <input className="border p-2 w-full rounded" placeholder="예: 5g, 10g" value={sampleQty} onChange={(e) => setSampleQty(e.target.value)} />
                ...
                <th className="border border-black bg-gray-50 p-3 font-semibold text-center whitespace-normal">의뢰부서</th>
                <td className="border border-black p-2 bg-white/80">
              ...
              {/* 6행: 의뢰자(채취자) / 빈칸 */}
              <tr>
                <th className="border border-black bg-gray-50 p-3 font-semibold text-center whitespace-normal">의뢰자</th>
                <td className="border border-black p-2 bg-white/80">
              ...
              {/* 7행: 비고 */}
              <tr>
                <th className="border border-black bg-gray-50 p-3 font-semibold text-center whitespace-normal">비고<br />(참고사항)</th>
